                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td style="padding: 5px;">
                                <input style="font-size: 2.3rem;" type="text" id="Login" placeholder="Nome de Usuário">
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 5px;">
                    ...
                    <p style="font-size: 1.4rem; text-align: center;">
                        Não é logado? <a href="Cadastro.jsp" style="font-size: 1.4rem;font-family: 'Yanone Kaffeesatz', sans-serif; text-decoration: underline;">Cadastre-se</a>
                    </p>
                </center>
            </form>
        </div>
